...
################################################################
# This is a generated script based on design: Full_Design
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Write_Data_0, and set properties
  set block_name Write_Data
  set block_cell_name Write_Data_0
  if { [catch {set Write_Data_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Write_Data_0 eq "" } {
  ...
  connect_bd_net -net Net [get_bd_pins Write_Data_0/clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net Write_Data_0_data [get_bd_pins Write_Data_0/data] [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net Write_Data_0_enable [get_bd_pins Write_Data_0/enable] [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins ila_0/probe2]
  connect_bd_net -net Write_Data_0_rst [get_bd_pins Write_Data_0/rst] [get_bd_pins blk_mem_gen_0/rstb] [get_bd_pins ila_0/probe3]
  connect_bd_net -net Write_Data_0_wea [get_bd_pins Write_Data_0/wea] [get_bd_pins blk_mem_gen_0/web]
