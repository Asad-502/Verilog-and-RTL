...
HD_PWD='E:/Git_Hub/FPGA/Verilog/Write_Read_Data_SoC_Application/Bram_Read_Write/Bram_Read_Write.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Full_Design_wrapper.tcl -notrace
