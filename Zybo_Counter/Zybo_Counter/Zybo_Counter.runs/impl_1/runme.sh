...
HD_PWD='E:/FYP/Zybo/Zybo_Counter/Zybo_Counter/Zybo_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Zybo_Counter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Zybo_Counter_wrapper.tcl -notrace
