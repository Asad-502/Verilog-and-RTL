...
HD_PWD='E:/FYP/Zybo/Zybo_Counter/Zybo_Counter/Zybo_Counter.runs/Zybo_Counter_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zybo_Counter_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zybo_Counter_auto_pc_0.tcl
