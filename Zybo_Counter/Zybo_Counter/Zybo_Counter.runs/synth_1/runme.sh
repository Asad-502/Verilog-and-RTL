...
HD_PWD='E:/FYP/Zybo/Zybo_Counter/Zybo_Counter/Zybo_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zybo_Counter_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zybo_Counter_wrapper.tcl
