...
HD_PWD='C:/Users/Asad Ur Rehman/Desktop/Memory_Design/Basic_Memory_Design/Basic_Memory_Design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Basic_Memory_Design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Basic_Memory_Design.tcl
