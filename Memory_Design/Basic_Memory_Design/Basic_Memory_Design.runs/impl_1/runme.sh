...
HD_PWD='C:/Users/Asad Ur Rehman/Desktop/Memory_Design/Basic_Memory_Design/Basic_Memory_Design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Basic_Memory_Design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Basic_Memory_Design.tcl -notrace
