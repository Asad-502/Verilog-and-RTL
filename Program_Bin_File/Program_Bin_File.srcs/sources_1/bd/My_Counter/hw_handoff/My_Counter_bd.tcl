...
################################################################
# This is a generated script based on design: My_Counter
#
...
proc create_root_design { parentCell } {
  ...
  set counter_out [ create_bd_port -dir O -from 3 -to 0 counter_out ]
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins counter_0/clk]
  connect_bd_net -net counter_0_counter_out [get_bd_ports counter_out] [get_bd_pins counter_0/counter_out]
