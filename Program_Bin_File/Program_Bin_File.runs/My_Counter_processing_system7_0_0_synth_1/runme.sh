...
HD_PWD='E:/FYP/Zybo/Program_Bin_File/Program_Bin_File.runs/My_Counter_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log My_Counter_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source My_Counter_processing_system7_0_0.tcl
