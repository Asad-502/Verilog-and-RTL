...
HD_PWD='E:/FYP/Zybo/Program_Bin_File/Program_Bin_File.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log My_Counter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source My_Counter_wrapper.tcl -notrace
