...
module Utility_Vectors
   (Middle_Output,
    ...
    Op2_0,
    Out_Put);
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.MIDDLE_OUTPUT DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.MIDDLE_OUTPUT, LAYERED_METADATA undef" *) output [7:0]Middle_Output;
  input [7:0]Op1_0;
  input [7:0]Op2_0;
  output Out_Put;
  ...
  assign Middle_Output[7:0] = util_vector_logic_0_Res;
