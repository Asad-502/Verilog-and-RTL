...
HD_PWD='E:/FYP/FPGA_XILINX/Edge_Detect_Pos_Or_Neg/Edge_Detect_Pos_Or_Neg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Edge_Detect.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Edge_Detect.tcl -notrace
