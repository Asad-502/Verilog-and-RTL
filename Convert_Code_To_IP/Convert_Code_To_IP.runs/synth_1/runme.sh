...
HD_PWD='E:/FYP/FPGA_XILINX/Convert_Code_To_IP/Convert_Code_To_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Add_My_IP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Full_Add_My_IP.tcl
