...
HD_PWD='E:/FYP/FPGA_XILINX/Convert_Code_To_IP/Convert_Code_To_IP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Add_My_IP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Full_Add_My_IP.tcl -notrace
