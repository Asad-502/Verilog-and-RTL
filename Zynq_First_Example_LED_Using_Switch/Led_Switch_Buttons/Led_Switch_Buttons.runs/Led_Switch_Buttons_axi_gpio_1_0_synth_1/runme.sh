...
HD_PWD='E:/FYP/Zybo/Zynq_First_Example_LED_Using_Switch/Led_Switch_Buttons/Led_Switch_Buttons.runs/Led_Switch_Buttons_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Led_Switch_Buttons_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Led_Switch_Buttons_axi_gpio_1_0.tcl
