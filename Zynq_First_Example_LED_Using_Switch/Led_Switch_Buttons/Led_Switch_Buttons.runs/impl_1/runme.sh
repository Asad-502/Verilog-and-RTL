...
HD_PWD='E:/FYP/Zybo/Zynq_First_Example_LED_Using_Switch/Led_Switch_Buttons/Led_Switch_Buttons.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Led_Switch_Buttons_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Led_Switch_Buttons_wrapper.tcl -notrace
