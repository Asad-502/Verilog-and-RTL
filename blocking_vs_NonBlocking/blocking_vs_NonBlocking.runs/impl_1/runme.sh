...
HD_PWD='C:/Users/Asad Ur Rehman/Desktop/Lab_9/blocking_vs_NonBlocking/blocking_vs_NonBlocking.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sawtooth.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sawtooth.tcl -notrace
