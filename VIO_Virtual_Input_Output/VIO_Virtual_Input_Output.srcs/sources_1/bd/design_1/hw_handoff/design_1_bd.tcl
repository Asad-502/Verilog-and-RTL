...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Nand_Gate_0_c [get_bd_pins Nand_Gate_0/c] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins vio_0/clk]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins Nand_Gate_0/a] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net vio_0_probe_out1 [get_bd_pins Nand_Gate_0/b] [get_bd_pins vio_0/probe_out1]
