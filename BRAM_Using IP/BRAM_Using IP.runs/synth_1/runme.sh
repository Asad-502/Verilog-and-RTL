...
HD_PWD='E:/FYP/FPGA_XILINX 2/BRAM_Using IP/BRAM_Using IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_Using_IP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_Using_IP.tcl
