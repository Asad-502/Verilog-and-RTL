...
################################################################
# This is a generated script based on design: NAND_Gate
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net a_0_1 [get_bd_ports a_0] [get_bd_pins AND_Gate_0/a]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports led] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net b_0_1 [get_bd_ports b_0] [get_bd_pins AND_Gate_0/b]
