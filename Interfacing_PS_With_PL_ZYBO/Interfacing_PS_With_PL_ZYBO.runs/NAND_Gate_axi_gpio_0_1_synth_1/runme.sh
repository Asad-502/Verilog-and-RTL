...
HD_PWD='E:/FYP/Zybo/Interfacing_PS_With_PL_ZYBO/Interfacing_PS_With_PL_ZYBO.runs/NAND_Gate_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NAND_Gate_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NAND_Gate_axi_gpio_0_1.tcl
