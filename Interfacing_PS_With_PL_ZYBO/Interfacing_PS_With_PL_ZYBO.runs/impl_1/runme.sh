...
HD_PWD='E:/FYP/Zybo/Interfacing_PS_With_PL_ZYBO/Interfacing_PS_With_PL_ZYBO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NAND_Gate_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NAND_Gate_wrapper.tcl -notrace
