...
HD_PWD='E:/FYP/Zybo/Interfacing_PS_With_PL_ZYBO/Interfacing_PS_With_PL_ZYBO.runs/NAND_Gate_AND_Gate_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NAND_Gate_AND_Gate_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NAND_Gate_AND_Gate_0_0.tcl
